            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Customers List</h4>
														...
														@if(!$user->isEmpty())
															@foreach($user as $row)
																<tr>
																	...
																	@endif</td>
																	<td>
																	<a href="admin-customer-details/{{$row->user_id}}" title="View"> <i class="fa fa-eye delet" aria-hidden="true"></i></a>
																		@if($row->user_status == 0)
																		<a href="admin-customer-status/{{$row->user_id}}" onclick="return confirm('Are you sure to change status ?')" title="Click to active"> <i class="fa fa-check cncl1" aria-hidden="true"></i></a>
																		@elseif($row->user_status == 1)
																		<a href="admin-customer-status/{{$row->user_id}}" onclick="return confirm('Are you sure to change status ?')" title="Click to inactive"> <i class="fa fa-times delet" aria-hidden="true"></i></a>
