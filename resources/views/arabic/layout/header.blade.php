						...
						<ul>
							<li>
								...
								<div class="drop_for_signup2">
									<a href="login"> @lang('messages.login') <i class="fa fa-sign-in" aria-hidden="true"></i></a>
									<a href="seller-signup"> @lang('messages.seller_signup') <i class="fa fa-user-o" aria-hidden="true"></i></a>
									<a href="customer-signup"> @lang('messages.customer_signup') <i class="fa fa-user-o" aria-hidden="true"></i></a>
								</div>
							</li>
				...
				<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
					...
					<div class="collapse navbar-collapse" id="myNavbar">
						<ul class="nav navbar-nav">
							<li><a id="m1" class="#" href="#">
							<i class="fa fa-caret-down make_arrow" aria-hidden="true"></i> @lang('messages.category') <i class="fa fa-list-ul" aria-hidden="true"></i> </a></li>
