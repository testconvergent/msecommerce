...
<title>@yield('title')</title>
	<!--style-->
    <link href="arabic_css/style.css" type="text/css" rel="stylesheet" media="all"/>
    <link href="arabic_css/responsive.css" type="text/css" rel="stylesheet" media="all"/>
    <!--bootstrape-->
    <link href="arabic_css/bootstrap.min.css" type="text/css" rel="stylesheet" media="all"/>
    <!--font-awesome-->
    <link href="arabic_css/font-awesome.min.css" type="text/css" rel="stylesheet" media="all"/>
    <!--fonts-->
    <link href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700,900" rel="stylesheet"> 
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet"> 
    <!-- Owl Stylesheets -->
    <!--<link rel="stylesheet" href="css/docs.theme.min.css">-->
    <link rel="stylesheet" href="arabic_css/owl.carousel.min.css">
    <link rel="stylesheet" href="arabic_css/owl.theme.default.min.css">
