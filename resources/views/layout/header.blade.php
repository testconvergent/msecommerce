		...
		<div class="top_header">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-7 col-sm-6 col-xs-9 make_search">
					...
					@endif
					@if(session()->get('user_id') != "")
						<div class="col-md-2 col-sm-3 col-xs-3 make_log no_pad_l after_login">
                            <div class="log_cart">
                            	<ul>
                            ...
                            <div class="dashboard_header">
                              ...
                              <div class="dropdown_dash" style="display:none;">
                                 <ul>
                                   ...
                                   <li><a href="#"><i class="fa fa-cog ad_tt" aria-hidden="true"></i> @lang('messages.setting')</a></li>
