...
$.extend($.validator, {
	...
	messages: {
		...
		numdash: "Please enter valid date of birth.",
	...
	classRuleSettings: {
		...
		strong_password: {strong_password: true},
		url: {url: true},
		date: {date: true},
		dateISO: {dateISO: true},
		number: {number: true},
		numdash: {numdash: true},
		digits: {digits: true},
	...
	methods: {
		...
		email: function(value, element) {
			...
			/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i.test(value);
		},
		...
		numdash: function(value, element) {
			return this.optional(element) || /^[0-9 +-]+$/.test(value);
		},
